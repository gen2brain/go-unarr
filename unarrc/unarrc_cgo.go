...
#cgo CFLAGS: -Iexternal/lzma -Iexternal/zlib -Iexternal/bzip2 -Iexternal/unarr -fomit-frame-pointer -Wno-typedef-redefinition -Wno-unknown-warning -Wno-unknown-warning-option
